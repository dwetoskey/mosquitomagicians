...
function Footer() {
    ...
    return (
        <Container className=''>
            <Carousel controls={false} indicators={false} className=' footercarousel desktop'>
                <Carousel.Item>
            ...
            <Carousel controls={false} indicators={false} className=' footercarouselmobile mobile'>
                <Carousel.Item>
